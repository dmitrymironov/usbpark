...
FORMS += SoundsTab.ui GUITab.ui WebCamTab.ui FirmwareUpdateTab.ui DiagnosticsTab.ui thermoTab.ui
...
win32 {
	...
	LIBPATH += $(INSTALL_LIB)
	LIBPATH += $(QTDIR)//plugins/imageformats
...
SOURCES = \
	VoiceNotification.cpp \
	parkAssist.cpp \
	parkSetup.cpp \
	PASettings.cpp \
	parktronic.cpp	\
	parktronicWindow.cpp
...
CONFIG(debug,debug|release) {
	...
	unix:LIBS += -lparkD -lhid -lwidget -lnvspeak
    DESTDIR = $$(INSTALL_BIN)
} else  {
    TARGET = parker
...
RESOURCES = parktronic.qrc hex/firmware.qrc
